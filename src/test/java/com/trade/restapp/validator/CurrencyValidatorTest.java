...
public class CurrencyValidatorTest {
    ...
    public void test_CurrencyValidator_Valid_Currencies_No_HolidaysMatch() throws ParseException {
        ...
        doReturn(Optional.of(HOLIDAYS)).when(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("EUR"));
        doReturn(Optional.of(HOLIDAYS)).when(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("USD"));
        ...
        order.verify(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("EUR"));
        order.verify(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("USD"));
    ...
    public void test_CurrencyValidator_Valid_Currencies_No_Holidays_Match() throws ParseException {
        ...
        doReturn(Optional.of(HOLIDAYS_WITH_TODAY)).when(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("EUR"));
        doReturn(Optional.of(HOLIDAYS_WITH_TODAY)).when(mockedCurrencyHolidayService).receiveHolidays(Currency.getInstance("USD"));
